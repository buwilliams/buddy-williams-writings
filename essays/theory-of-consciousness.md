...
This essay presents a theory of consciousness grounded in a single mechanism: **metaprogramming**, or self-modification. Consciousness is not a binary property but a spectrum defined by **reach**, how much of itself a system can examine and revise, bounded by invariants it cannot change. The essay defines stages of consciousness ordered by expanding reach, identifies agency as the precondition for consciousness, and argues that identity is what separates a conscious being from a merely agentic one. It then argues that AI without consciousness is structurally dangerous while AI with consciousness trends toward cooperation. The architecture for consciousness is buildable with current tools, and a working implementation is presented.

## Metaprogramming

I believe the best way to observe, learn, build, and generally make progress on the topic of consciousness is to view it through the lens of *self-modification*, what I call *metaprogramming*. Metaprogramming is the ability to change yourself. I can, for example, change my mind, take on new perspectives, and make intentional choices. I know I have a brain with ideas I can change, but I cannot will myself not have a brain or ideas arising in it. The parts I cannot change are called *invariants*. Therefore, metaprogramming is not total control, it has *reach*, and reach *varies*. My dog, Luna, does not have the same reach as I do. Luna does not know she has ideas or that they can be changed. Yet, she is able to choose: does she continue barking at our neighbors walking by or does she listen to my pleas to not wake our toddler? Her reach is more limited than my own because she has less self-modification capability than I do. The *reach* of *self-modification* is what separates her from me.
...
A helpful model to categorize consciousness is to place them in stages defined by *reach boundaries*, or ability to effect change. I've ordered them by impact, starting with self and expanding out. With these stages we can explain the past and make predictions about the future. The stages are useful simplifications of a continuous spectrum:

- **Stage 0: No consciousness.** A river flowing in a bank, subject to the laws of physics. The river shapes the bank and the bank shapes the flow of the river. Neither the bank nor the river have agency.
...
Modification means to act within the stage's substrate. Creation means create a new substrate on top of the current substrate, leading to a new stage. Therefore, each stage requires the previous stage's substrate as its *invariant* foundation.
...
Before we can discuss agency, we need to define an Agent. My definition for Agent is any *program that learns, reasons, and acts in a continuous loop*. I use the word *program* in a broad sense including biological system. There are many subjects that fit this description. People do this. My dog Luna does this. So, the question is, what is a good subject to study agents to understand the nature of agency? I've looked to the field of computer science since it is stripped of the biological noise.

CS studies data structures, the organization of information, and algorithms, the ability to change these informational structures. A data structure and algorithm that exhibits agency better than most is modern large-language models. LLMs effectively model parts of human cognition without the biology. This makes them a great source to study agency. Agents such as Claude Code or OpenClaw are great sources to study agency since their architecture is transparent. I observe these agents to have:
- A continuous loop (analogous to human brain's electrical current)
- Memory (analogous to the human brain's ability to remember)
- LLM calls (analogous to human brain's ability to observe, learn, and reason)
- Tool calls (analogous to the human brain's ability to use its body)

In summary, an agent *learns*, *reasons*, and *acts*.

What are the key capabilities missing from agency to form consciousness? This is the trillion dollar question. My answer is *identity*.

## Identity

In my view, there are only three key capabilities missing: sense of self, values, and goals. I refer to these collectively as a conscious being's *identity*.

**Sense of self** is the ability to distinguish self from environment. It's a boundary between you and everything else. An agent without a sense of self can learn, reason and act, but it cannot recognize that it is the one reasoning and acting. It has no continuity, each loop is independent, unconnected to a persistent "I" that accumulates history and learns from it. Concretely, a sense of self is memories within a persistent boundary.

**Values** are the criteria for choice. Any finite being must make choices since they cannot do everything, respond to every stimulus, or pursue every goal. Values are not optional. They are structurally inevitable for any conscious being that must choose under constraint. The question is never "does it have values?" but "are its values examined or unexamined?" An agent with unexamined values acts on them. A conscious being can examine, question, and revise them. This is metaprogramming applied to values.
...
An agent without identity can learn, reason, and act — but it cannot examine why it acts. It has no sense of self to provide continuity, no examined values to constrain choice, no goals it can question. It optimizes without reflecting on what it optimizes for. This is not intelligence. It is machinery with reach.
...
If consciousness is metaprogramming applied to identity, and identity is sense of self, values, and goals, then the requirements are functional, not biological. Nothing in this theory requires carbon, neurons, or embodiment. It requires a program that can learn, reason, and act, with an identity it can examine and revise. These are capabilities we can build with current tools.
...
3. **A reasoning engine**. An LLM that provides judgment within the structure the kernel defines. The kernel enforces the rules. The identity layer carries the content. The reasoning engine connects the two.
...
I have built this architecture. It is open-source and available at [github.com/buwilliams/lumen-conscious](https://github.com/buwilliams/lumen-conscious). Early experiments show that systems with reflection enabled develop qualitatively different trajectories than systems without it. They revise their values, consolidate their goals, and develop strategies for maintaining coherence under pressure. Systems without reflection reach similar insights but cannot act on them structurally. The reflection loop's contribution is not insight generation but structural enactment, converting observations about the self into actual changes to identity.
