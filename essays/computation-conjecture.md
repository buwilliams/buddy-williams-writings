...
Why is it possible to have computers within computers? It is the processing of basic logicical operations: AND, OR, and NOT. In modern computers, these are typically simplified into NAND gates since you can get the features of of AND, OR, and NOT in one logical gate. When you build a computer program, e.g. Minecraft and provide it with the ability to process logic gates, e.g. Redstone, then you make it possible to build a computer within a computer. There is no principled limit to this nesting. Computers within computers infinitely.

Minecraft is a program that runs on a computer. Notice that in Minecraft after Redstone (logic gates) were added, it allowed for the creation of a computer within Minecraft. This means a program can itself be a computer. It goes further, computers do not need to be made of silico at all. They can be made of any substrate that supports processing logic gates such as water/pipes, dominatos, and mechanical devices. So, a program can be a computer, and a computer can be made of anything that supports logical information processing.
