...
|------|--------|------|-------------|
| Apr 2026 | Draft | [computation-conjecture.md](essays/computation-conjecture.md) | Computation Conjecture. Argues that computation has more explanatory reach than physicalism. Develops closed causal systems, observer locality, and substrate independence from nested computers we already build. Physicalism correctly describes our local ruleset; computation additionally accounts for why a closed causal system with observers exists at all. Replaces the earlier what-is-existence.md draft. |
