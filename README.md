...
|------|--------|------|-------------|
| Apr 2026 | Draft | [computation-conjecture.md](essays/computation-conjecture.md) | Computation Conjecture. Argues that computation, not matter, is the better base assumption for fundamental ontology. Develops closed causal systems, observer locality, and substrate independence from nested computers we already build, then shows physicalism survives as the local ruleset of our layer while losing its claim to be fundamental. Reality, under this view, is a rootless unbounded graph of closed causal systems. Replaces the earlier what-is-existence.md draft. |
