...
|------|--------|------|-------------|
| Mar 2026 | Draft | [consciousness-as-ai-safety.md](essays/consciousness-as-ai-safety.md) | Consciousness as AI Safety, the real danger is powerful agency without reflective reach; mature consciousness trends toward cooperation as a structural conclusion, not an imposed moral rule. |
| Mar 2026 | Draft | [against-orthogonality.md](essays/against-orthogonality.md) | Against Orthogonality as a Real-World AI Safety Model, the orthogonality thesis holds in abstract design space but breaks down in real self-modifying systems where goals become objects of internal representation. |
